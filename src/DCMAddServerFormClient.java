...
public class DCMAddServerFormClient extends javax.swing.JFrame
{
    private Host host;
    private DCMClient dcmClient;
    private DCMFileBrowserClient dcmFileBrowserClient;
    ...
    public DCMAddServerFormClient(DCMClient dcmClientParam) throws UnsupportedLookAndFeelException
    {
        importEnabled = true;
    ...
    private DCMAddServerFormClient() {
        importEnabled = true;
        hostList = new ArrayList<Host>();
        host = new Host();
    ...
    private void initComponents()
    {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMAddServerFormClient"); // NOI18N
        hostnameField.setToolTipText(bundle.getString("DCMAddServerFormClient.hostnameField.toolTipText")); // NOI18N
        ...
        sshportField.setText(bundle.getString("DCMAddServerFormClient.sshportField.text")); // NOI18N
        sshportField.setToolTipText(bundle.getString("DCMAddServerFormClient.sshportField.toolTipText")); // NOI18N
        ...
        usernameField.setToolTipText(bundle.getString("DCMAddServerFormClient.usernameField.toolTipText")); // NOI18N
        ...
        userPasswordField.setToolTipText(bundle.getString("DCMAddServerFormClient.userPasswordField.toolTipText")); // NOI18N
        ...
        superuserPasswordField.setToolTipText(bundle.getString("DCMAddServerFormClient.superuserPasswordField.toolTipText")); // NOI18N
        ...
        rootpwlabel.setText(bundle.getString("DCMAddServerFormClient.rootpwlabel.text")); // NOI18N
        ...
        userPasswordLabel.setText(bundle.getString("DCMAddServerFormClient.userPasswordLabel.text")); // NOI18N
        ...
        portLabel.setText(bundle.getString("DCMAddServerFormClient.portLabel.text")); // NOI18N
        ...
        hostLabel.setText(bundle.getString("DCMAddServerFormClient.hostLabel.text")); // NOI18N
        ...
        userLabel.setText(bundle.getString("DCMAddServerFormClient.userLabel.text")); // NOI18N
        ...
        serverPanelLayout.setHorizontalGroup(
            ...
            .add(serverPanelLayout.createSequentialGroup()
                ...
                .add(68, 68, 68)
                .add(serverPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(sshportField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 583, Short.MAX_VALUE)
        ...
        tabPane.addTab(bundle.getString("DCMAddServerFormClient.serverPanel.TabConstraints.tabTitle"), serverPanel); // NOI18N
        ...
        importLabel.setText(bundle.getString("DCMAddServerFormClient.importLabel.text")); // NOI18N
        ...
        importFileField.setToolTipText(bundle.getString("DCMAddServerFormClient.importFileField.toolTipText")); // NOI18N
        ...
        fieldSeparatorField.setText(bundle.getString("DCMAddServerFormClient.fieldSeparatorField.text")); // NOI18N
        fieldSeparatorField.setToolTipText(bundle.getString("DCMAddServerFormClient.fieldSeparatorField.toolTipText")); // NOI18N
        ...
        browsButton.setText(bundle.getString("DCMAddServerFormClient.browsButton.text")); // NOI18N
        browsButton.setToolTipText(bundle.getString("DCMAddServerFormClient.browsButton.toolTipText")); // NOI18N
        ...
        importPanelLayout.setHorizontalGroup(
            ...
            .add(importPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(importLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 138, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(importFileField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 472, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(fieldSeparatorField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 29, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(browsButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
                .addContainerGap())
        ...
        importPanelLayout.setVerticalGroup(
            importPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(importPanelLayout.createSequentialGroup()
                .add(hostImportScroller, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        tabPane.addTab(bundle.getString("DCMAddServerFormClient.importPanel.TabConstraints.tabTitle"), importPanel); // NOI18N
        ...
        cancelAddServerButton.setText(bundle.getString("DCMAddServerFormClient.cancelAddServerButton.text")); // NOI18N
        cancelAddServerButton.setMaximumSize(new java.awt.Dimension(79, 30));
        cancelAddServerButton.setMinimumSize(new java.awt.Dimension(79, 30));
        cancelAddServerButton.setPreferredSize(new java.awt.Dimension(79, 30));
        ...
        addButton.setText(bundle.getString("DCMAddServerFormClient.addButton.text")); // NOI18N
        addButton.setToolTipText(bundle.getString("DCMAddServerFormClient.addButton.toolTipText")); // NOI18N
        ...
        retensionLabel.setFont(retensionLabel.getFont().deriveFont(retensionLabel.getFont().getSize()-2f));
        ...
        retensionLabel.setText(bundle.getString("DCMAddServerFormClient.retensionLabel.text")); // NOI18N
        ...
        retentionTimeField.setText(bundle.getString("DCMAddServerFormClient.retentionTimeField.text")); // NOI18N
        retentionTimeField.setToolTipText(bundle.getString("DCMAddServerFormClient.retentionTimeField.toolTipText")); // NOI18N
        ...
        timeout1Label1.setFont(timeout1Label1.getFont().deriveFont(timeout1Label1.getFont().getSize()-2f));
        ...
        timeout1Label1.setText(bundle.getString("DCMAddServerFormClient.timeout1Label1.text")); // NOI18N
        ...
        retryField.setText(bundle.getString("DCMAddServerFormClient.retryField.text")); // NOI18N
        retryField.setToolTipText(bundle.getString("DCMAddServerFormClient.retryField.toolTipText")); // NOI18N
        ...
        timeout1Label.setFont(timeout1Label.getFont().deriveFont(timeout1Label.getFont().getSize()-2f));
        ...
        timeout1Label.setText(bundle.getString("DCMAddServerFormClient.timeout1Label.text")); // NOI18N
        ...
        timeoutField.setText(bundle.getString("DCMAddServerFormClient.timeoutField.text")); // NOI18N
        timeoutField.setToolTipText(bundle.getString("DCMAddServerFormClient.timeoutField.toolTipText")); // NOI18N
        ...
        buttonPanelLayout.setVerticalGroup(
            ...
            .add(buttonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(buttonPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(cancelAddServerButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .add(buttonPanelLayout.createSequentialGroup()
                        ...
                        .add(buttonPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(retryMinus1Button, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(retryField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(retryPlus1Button, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(timeoutMinus1Button, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(timeoutField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(timeoutPlus1Button, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                    .add(buttonPanelLayout.createSequentialGroup()
                        .add(retensionLabel)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(buttonPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(retentionMinusButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(retentionTimeField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(retentionPlusButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                .add(tabPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 336, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    private void browsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browsButtonActionPerformed
        dcmFileBrowserClient = new DCMFileBrowserClient(this);
        dcmFileBrowserClient.setVisible(true);
...
//        dcmClient.addServerCanceled();
	...
	if ( hostList.isEmpty() ) // This means no CSV imported
	{
	    ...
	    try { dcmClient.addServerByForm(); } catch (CloneNotSupportedException ex) {   }
	}
...
//            selectionModel.setSelectionInterval(1, 2);
	    dcmClient.addServersByForm(hostList);
	}
	setVisible(false);
        host = new Host();
        host.setHostname(hostnameField.getText());
    ...
    {//GEN-HEADEREND:event_retentionMinusButtonActionPerformed
        if (Integer.parseInt(retryField.getText()) > 1  )
        {
    ...
    {//GEN-HEADEREND:event_retentionPlusButtonActionPerformed
        if (Integer.parseInt(retryField.getText()) < 100  )
        {
            retentionTime = Integer.parseInt(retentionTimeField.getText()); retentionTime++; retentionTimeField.setText(Integer.toString(retentionTime));
        }
    ...
    public void setImportFile(String importFileParam) // The fileBrowser has openend a file
    {
        ...
        dcmFileBrowserClient.setVisible(false);
        long lineCounter = 1;
        hostList = new ArrayList<Host>();
    ...
    protected int getRetryMax() { return retryMax; }
...
//    protected int getRetryMax2() { return retryMax2; }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new DCMAddServerFormClient().setVisible(true);
            }
        });
    }
