...
public class DCMPopupMenusClient // FrontEnd
{
    ...
    public DCMPopupMenusClient(final DCMClient dcmClient)
    {
...
// Datacenter Menu
        ...
        datacenterMenuItemRefreshMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me) { datacenterMenu.setVisible(false); try { dcmClient.buildServerTree(); } catch (CloneNotSupportedException ex) {   } }
        ...
        datacenterMenuItemAddServerMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { datacenterMenu.setVisible(false); if (datacenterMenuItemAddServer.isEnabled()) { dcmClient.addServerFormClient.setVisible(true);} }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        serverMenuItemUpdateServersMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) {  }
            @Override public void mousePressed(MouseEvent me) { datacenterMenu.setVisible(false); if (serverMenuItemUpdateServers.isEnabled()) { try { dcmClient.updateServers(); } catch (CloneNotSupportedException ex) {   } }}
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        datacenterMenuItemDeleteAllServersMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { datacenterMenu.setVisible(false); if (datacenterMenuItemDeleteAllServers.isEnabled()) { dcmClient.openDeleteAllServerForm(); } }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
...
// Server Menu        
        ...
        serverMenuItemDisablePollingMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { serverMenu.setVisible(false); if (serverMenuItemDisablePolling.isEnabled()) { try { dcmClient.enablePollingSelectedServers(false); } catch (CloneNotSupportedException ex) {   }; } }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        serverMenuItemEnablePollingMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { serverMenu.setVisible(false); if (serverMenuItemEnablePolling.isEnabled()) { try { dcmClient.enablePollingSelectedServers(true); } catch (CloneNotSupportedException ex) {   }; } }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        serverMenuItemUpdateServerMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) {  }
            @Override public void mousePressed(MouseEvent me) { serverMenu.setVisible(false); if (serverMenuItemUpdateServer.isEnabled()) { try { dcmClient.updateServer(); } catch (CloneNotSupportedException ex) {   } }}
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        serverMenuItemDeleteServerMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                ...
                {
//                    dcManagerClient.deleteServerFormClient.setHostname(dcManagerClient.serverTree.getSelectionPath().getLastPathComponent().toString());
                    ArrayList<String> serverList = new ArrayList<String>();
                    for (TreePath tp:dcmClient.serverTree.getSelectionPaths()) { serverList.add(tp.getLastPathComponent().toString()); }
//                    dcmClient.deleteServerFormClient.setServerList(serverList);
                    dcmClient.openDeleteServerForm(serverList);
                }
            }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
...
// Graph Menu
        ...
        graphMenuItemRefreshMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                ...
                dcmClient.setCursor(Cursor.WAIT_CURSOR);
...
//                        dcManager.setGraph(dcManager.getTrend(false,dcManager.getImageWidth(),dcManager.getImageHeight(),dcManager.manualValueMode,dcManager.startCalendar,dcManager.endCalendar,dcManager.valueLimits)); // MiddleWare Invocation
                        try { dcmClient.setGraph(dcmClient.dcmClientRMI.getTrend(dcmClient.getColorList(false, dcmClient.selectionArea.getText()),dcmClient.getImageWidth(),dcmClient.getImageHeight(),dcmClient.manualValueMode,dcmClient.startCalendar,dcmClient.endCalendar,dcmClient.valueLimits, dcmClient.selectionArea.getText(), dcmClient.lineType)); } catch (CloneNotSupportedException ex) {   } // MiddleWare Invocation
                    }
                });
...
//                        dcManager.setGraph(dcManager.getTrend(false,dcManager.getImageWidth(),dcManager.getImageHeight(),dcManager.manualValueMode,dcManager.startCalendar,dcManager.endCalendar,dcManager.valueLimits)); // MiddleWare Invocation
                        dcmClient.manualValueMode = false; // New graph = auto value ax
                        try { dcmClient.setGraph(dcmClient.dcmClientRMI.getTrend(dcmClient.getColorList(false, dcmClient.selectionArea.getText()),dcmClient.getImageWidth(),dcmClient.getImageHeight(),dcmClient.manualValueMode,dcmClient.startCalendar,dcmClient.endCalendar,dcmClient.valueLimits, dcmClient.selectionArea.getText(), dcmClient.lineType)); } catch (CloneNotSupportedException ex) {   } // MiddleWare Invocation
                    }
                });
        ...
        graphMenuItemCenterTimeMouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { graphMenu.setVisible(false); dcmClient.centerTime(evt); }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        graphMenuItemMaxTo100MouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { graphMenu.setVisible(false); dcmClient.setMaxValueTo100(); }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        graphMenuItemMinTo0MouseListener = new MouseListener()
        {
            ...
            @Override public void mouseClicked(MouseEvent me) { }
            @Override public void mousePressed(MouseEvent me) { graphMenu.setVisible(false); dcmClient.setMinValueTo0(); }
            @Override public void mouseReleased(MouseEvent me) {  }
            @Override public void mouseEntered(MouseEvent me) {  }
            @Override public void mouseExited(MouseEvent me) { }
        };
        ...
        graphMenuItemLineBoldMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                graphMenu.setVisible(false); dcmClient.lineType = 2.0F;
                dcmClient.setCursor(Cursor.WAIT_CURSOR);
        ...
        graphMenuItemLineNormalMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                graphMenu.setVisible(false); dcmClient.lineType = 1.5F; 
                dcmClient.setCursor(Cursor.WAIT_CURSOR);
...
//                        dcManager.setGraph(dcManager.getTrend(false,dcManager.getImageWidth(),dcManager.getImageHeight(),dcManager.manualValueMode,dcManager.startCalendar,dcManager.endCalendar,dcManager.valueLimits)); // MiddleWare Invocation
        ...
        graphMenuItemLineFineMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                graphMenu.setVisible(false); dcmClient.lineType = 1.0F;
                dcmClient.setCursor(Cursor.WAIT_CURSOR);
...
//                        dcManager.setGraph(dcManager.getTrend(false,dcManager.getImageWidth(),dcManager.getImageHeight(),dcManager.manualValueMode,dcManager.startCalendar,dcManager.endCalendar,dcManager.valueLimits)); // MiddleWare Invocation
        ...
        graphMenuItemLineMicroMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                graphMenu.setVisible(false); dcmClient.lineType = 0.5F;
                dcmClient.setCursor(Cursor.WAIT_CURSOR);
        ...
        graphMenuItemShuffleColorsMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                ...
                Thread ShuffleColorsThread = new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
//                        dcManager.setGraph(dcManager.getTrend(true,dcManager.getImageWidth(),dcManager.getImageHeight(),dcManager.manualValueMode,dcManager.startCalendar,dcManager.endCalendar,dcManager.valueLimits)); // MiddleWare Invocation
                        try { dcmClient.setGraph(dcmClient.dcmClientRMI.getTrend(dcmClient.getColorList(true, dcmClient.selectionArea.getText()),dcmClient.getImageWidth(),dcmClient.getImageHeight(),dcmClient.manualValueMode,dcmClient.startCalendar,dcmClient.endCalendar,dcmClient.valueLimits, dcmClient.selectionArea.getText(), dcmClient.lineType)); } catch (CloneNotSupportedException ex) {   } // MiddleWare Invocation
                    }
                });
        ...
        graphMenuItemSaveImageMouseListener = new MouseListener()
        {
            ...
            @Override public void mousePressed(MouseEvent me)
            {
                ...
                Thread ShuffleColorsThread = new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        try { dcmClient.saveGraph(dcmClient.dcmClientRMI.getTrend(dcmClient.getColorList(false, dcmClient.selectionArea.getText()),dcmClient.getImageWidth(),dcmClient.getImageHeight(),dcmClient.manualValueMode,dcmClient.startCalendar,dcmClient.endCalendar,dcmClient.valueLimits, dcmClient.selectionArea.getText(), dcmClient.lineType)); } catch (CloneNotSupportedException ex) {   } // MiddleWare Invocation
                    }
                });
                ShuffleColorsThread.setName("ShuffleColorsThread");
                ShuffleColorsThread.setDaemon(true);
