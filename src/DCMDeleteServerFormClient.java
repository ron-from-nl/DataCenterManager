...
public class DCMDeleteServerFormClient extends javax.swing.JFrame
{
    String hostname;
    DCMClient dcmClient;

    public DCMDeleteServerFormClient(DCMClient dcManagerClientParam) throws UnsupportedLookAndFeelException
    {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMDeleteServerFormClient"); // NOI18N
        headerLabel.setText(bundle.getString("DCMDeleteServerFormClient.headerLabel.text")); // NOI18N
        ...
        hostLabel.setText(bundle.getString("DCMDeleteServerFormClient.hostLabel.text")); // NOI18N
        ...
        deleteArchives.setText(bundle.getString("DCMDeleteServerFormClient.deleteArchives.text")); // NOI18N
        deleteArchives.setToolTipText(bundle.getString("DCMDeleteServerFormClient.deleteArchives.toolTipText")); // NOI18N

        deleteButton.setFont(deleteButton.getFont().deriveFont(deleteButton.getFont().getSize()+1f));
        deleteButton.setText(bundle.getString("DCMDeleteServerFormClient.deleteButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("DCMDeleteServerFormClient.cancelButton.text")); // NOI18N
        ...
        deletePanelLayout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, deletePanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(deletePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, serverListScroller)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, deleteArchives)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, deletePanelLayout.createSequentialGroup()
                        .add(cancelButton)
        ...
        deletePanelLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, deletePanelLayout.createSequentialGroup()
                ...
                .add(hostLabel)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(serverListScroller, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(deleteArchives)
                ...
                .add(deletePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    ...
                    .add(deleteButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//        dcManager.deleteServerByForm(deleteArchives.isSelected());
        dcmClient.deleteServersByList(serverList, deleteArchives.isSelected());
    ...
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButtonActionPerformed
        setVisible(false);
        dcmClient.deleteServerCanceled();
