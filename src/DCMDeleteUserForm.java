...
public class DCMDeleteUserForm extends javax.swing.JFrame
{
    DCMUser dcmUser;
    DCMDesktop dcManager;

    public DCMDeleteUserForm(DCMDesktop dcManagerParam) throws UnsupportedLookAndFeelException
    {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMDeleteUserForm"); // NOI18N
        headerLabel.setText(bundle.getString("DCMDeleteUserForm.headerLabel.text")); // NOI18N
        ...
        hostLabel.setText(bundle.getString("DCMDeleteUserForm.hostLabel.text")); // NOI18N
        ...
        deleteButton.setText(bundle.getString("DCMDeleteUserForm.deleteButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("DCMDeleteUserForm.cancelButton.text")); // NOI18N
            ...
            .add(deletePanelLayout.createSequentialGroup()
                ...
                .add(deletePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(deletePanelLayout.createSequentialGroup()
                        .add(hostLabel)
                        .add(18, 18, 18)
                        .add(usernameLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        setVisible(false);
        dcManager.deleteDCMUserByForm(dcmUser.getId());
