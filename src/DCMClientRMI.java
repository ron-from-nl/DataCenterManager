...
public class DCMClientRMI implements Serializable
{
    ...
    // Trend Navigation
    public NavigatorPreset                  getDCMPreset(long idParam){ NavigatorPreset dcmPreset = null; try { dcmPreset = dcmServerRMI.getDCMPreset(idParam); } catch (RemoteException ex) { dcmClient.log("Error: : RemoteException: getDCMPreset " + ex.getMessage(), true, true, true); } return dcmPreset; }
    public ArrayList<NavigatorPreset>       getDCMPresetList() { ArrayList<NavigatorPreset> dcmPresetList = new ArrayList<NavigatorPreset>(); try { dcmPresetList = dcmServerRMI.getDCMPresetList(); } catch (RemoteException ex) { dcmClient.log("Error: : RemoteException: getgetDCMPresetList " + ex.getMessage(), true, true, true); } return dcmPresetList; }
    public ArrayList<RMIMessage>    insertDCMPreset(NavigatorPreset dcmPresetParam) throws CloneNotSupportedException { rmiMessageList.clear(); try { rmiMessageList = dcmServerRMI.insertDCMPreset(dcmPresetParam); } catch (RemoteException ex) { dcmClient.log("Error: : RemoteException: insertDCMPreset " + ex.getMessage(), true, true, true); } return rmiMessageList; }
    public ArrayList<RMIMessage>    updateDCMPreset(NavigatorPreset dcmPresetParam) throws CloneNotSupportedException { rmiMessageList.clear(); try { rmiMessageList = dcmServerRMI.updateDCMPreset(dcmPresetParam); } catch (RemoteException ex) { dcmClient.log("Error: : RemoteException: updateDCMPreset " + ex.getMessage(), true, true, true); } return rmiMessageList; }
    public ArrayList<RMIMessage>    deleteDCMPreset(NavigatorPreset dcmPresetParam) throws CloneNotSupportedException { rmiMessageList.clear(); try { rmiMessageList = dcmServerRMI.deleteDCMPreset(dcmPresetParam); } catch (RemoteException ex) { dcmClient.log("Error: : RemoteException: deleteDCMPreset " + ex.getMessage(), true, true, true); } return rmiMessageList; }
