...
public class DCMCommander extends javax.swing.JFrame  implements DCMDBClientCaller, ConfigurationCaller, DCMRemoteCommandCaller
{
...
//  End Redirection
    ...
    private String                  scriptTip;
    private String                  customPromptFlat;

    private final int               CMDSTAGE = 0;
    private boolean                 dcmDBClientIsReady = false;
    private DCMVergunning           dcmVergunning;
    private ArrayList<Server>       serverList;

    private String                  text;
    private static final String     THISPRODUCT = "DCMCommander";
    ...
    public DCMCommander(boolean debugParam)
    {
        scriptTip = "# Commands or Script to Execute";
...
//        setPreferredSize(new Dimension(Toolkit.getDefaultToolkit().getScreenSize().width,Toolkit.getDefaultToolkit().getScreenSize().height));
        ...
        dcmVergunning = new DCMVergunning(debug); // Middleware
...
//        copyrightLabel.setText(License.getCopyright() + " " + License.getCompany() + " - Author: " + License.getAuthor());
        ...
        // Begin MiddleWare        
        try { dcmDBClientThread = new DCMDBClient(dcmDBClientCaller, configuration.getJavaDB(), daemon, debug); }
        catch (SQLException ex)                 { log("InventoryGUI: SQLException", true, true, true); }
        catch (ClassNotFoundException ex)       { log("InventoryGUI: ClassNotFoundException: " + ex.getMessage(), true, true, true); }
        catch (InstantiationException ex)       { log("InventoryGUI: InstantiationException: " + ex.getMessage(), true, true, true); }
        catch (IllegalAccessException ex)       { log("InventoryGUI: IllegalAccessException: " + ex.getMessage(), true, true, true); }
        catch (NoSuchMethodException ex)        { log("InventoryGUI: NoSuchMethodException: " + ex.getMessage(), true, true, true); }
        catch (InvocationTargetException ex)    { log("InventoryGUI: InvocationTargetException: " + ex.getMessage(), true, true, true); }
        catch (Exception ex)                    { log("InventoryGUI: Exception: " + ex.getMessage(), true, true, true); }
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMCommander"); // NOI18N
        searchServerPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), bundle.getString("DCMCommander.searchServerPanel.border.title"), javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Lucida Grande", 0, 12), new java.awt.Color(102, 102, 102))); // NOI18N
        searchServerPanel.setFocusable(false);
        ...
        searchExactButton.setText(bundle.getString("DCMCommander.searchExactButton.text")); // NOI18N
        searchExactButton.setToolTipText(bundle.getString("DCMCommander.searchExactButton.toolTipText")); // NOI18N
        ...
        searchField.setToolTipText(bundle.getString("DCMCommander.searchField.toolTipText")); // NOI18N
        ...
        searchNonExactButton.setText(bundle.getString("DCMCommander.searchNonExactButton.text")); // NOI18N
        searchNonExactButton.setToolTipText(bundle.getString("DCMCommander.searchNonExactButton.toolTipText")); // NOI18N
        ...
        serversList.setToolTipText(bundle.getString("DCMCommander.serversList.toolTipText")); // NOI18N
        ...
        executeSequentialButton.setText(bundle.getString("DCMCommander.executeSequentialButton.text")); // NOI18N
        executeSequentialButton.setToolTipText(bundle.getString("DCMCommander.executeSequentialButton.toolTipText")); // NOI18N
        ...
        executeParallelButton.setText(bundle.getString("DCMCommander.executeParallelButton.text")); // NOI18N
        executeParallelButton.setToolTipText(bundle.getString("DCMCommander.executeParallelButton.toolTipText")); // NOI18N
        executeParallelButton.setActionCommand(bundle.getString("DCMCommander.executeParallelButton.actionCommand")); // NOI18N
        ...
        timeoutField.setText(bundle.getString("DCMCommander.timeoutField.text")); // NOI18N
        timeoutField.setToolTipText(bundle.getString("DCMCommander.timeoutField.toolTipText")); // NOI18N
        ...
        spawnSpeed.setText(bundle.getString("DCMCommander.spawnSpeed.text")); // NOI18N
        spawnSpeed.setToolTipText(bundle.getString("DCMCommander.spawnSpeed.toolTipText")); // NOI18N
        ...
        progressBar.setToolTipText(bundle.getString("DCMCommander.progressBar.toolTipText")); // NOI18N
        ...
        searchServerPanelLayout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, searchServerPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(executeSequentialButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 161, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(executeParallelButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 139, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        commandField.setToolTipText(bundle.getString("DCMCommander.commandField.toolTipText")); // NOI18N
        ...
        outputArea.setToolTipText(bundle.getString("DCMCommander.outputArea.toolTipText")); // NOI18N
        ...
        copyrightLabel.setText(bundle.getString("DCMCommander.copyrightLabel.text")); // NOI18N
...
//                setSelectionArea(dcmMetaDBClient.convertSearchStringToResourcesText(searchField.getText(),false));
    ...
    public ArrayList<Server> getServerList() throws CloneNotSupportedException
    {
        ...
        ArrayList<Server> serverList = dcmDBClient.selectServers();
        return serverList;
    }
    ...
    {
        try { serverList = getServerList(); } catch (CloneNotSupportedException ex) {   }
        String output = "";
        ...
        if (searchString.length() > 0) { output = dcmDBClient.convertSearchStringToHostsText(searchField.getText(),serverListLimited,true); }
        return output;
    }    
    // End MiddleWare
    ...
    private String searchNonExactHosts(String searchString)
    {
        ...
        if (searchString.length() > 0) { output = dcmDBClient.convertSearchStringToHostsText(searchField.getText(),serverListLimited,false); }
        return output;
    }    
    // End MiddleWare
...
// Here all arrays have been build ===============================================
                ...
                command.append(commandField.getText()).append("\n");
                command.append("echo \"").append(customPromptFlat).append("\"\n"); // Arranged prompt output for expect string in RemoteCommand
                    ...
                    if (threaded)
                    {
                        Thread parallelExecutionThread = new Thread(new Runnable()
                        {
                            ...
                            public void run()
                            {
                                ...
                                try { new DCMRemoteCommand(dcmRemoteCommandCaller, CMDSTAGE, host, command, true, sessionTimeout, debug); } catch (CloneNotSupportedException ex) { }
                            }
                        });
...
//                }
//                try { new DCMCommander(debug).setVisible(true); } catch (Exception ex) { System.out.println("Error: main(): "); }
//            }
//        });
//    }
//
