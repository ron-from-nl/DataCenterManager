...
public class DCMFileBrowserClient extends javax.swing.JFrame {
...
//        try { directory = new File(new File(".").getCanonicalPath() + fileSeparator + "data" + fileSeparator + "sounds"); } catch (IOException ex) { }
        ...
        this();
        addServerFormClient2 = addServerFormParam;
    ...
    private void fileChooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooserActionPerformed
        addServerFormClient2.setImportFile(fileChooser.getCurrentDirectory() + fileSeparator + fileChooser.getName(fileChooser.getSelectedFile()));
        setVisible(false);
