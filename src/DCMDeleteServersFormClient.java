...
public class DCMDeleteServersFormClient extends javax.swing.JFrame
{
    String hostname;
    DCMClient dcManagerClient;

    public DCMDeleteServersFormClient(DCMClient dcManagerClientParam) throws UnsupportedLookAndFeelException
    {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMDeleteServersFormClient"); // NOI18N
        headerLabel.setText(bundle.getString("DCMDeleteServersFormClient.headerLabel.text")); // NOI18N
        ...
        hostLabel.setText(bundle.getString("DCMDeleteServersFormClient.hostLabel.text")); // NOI18N
        ...
        hostnameLabel.setText(bundle.getString("DCMDeleteServersFormClient.hostnameLabel.text")); // NOI18N
        ...
        deleteArchives.setText(bundle.getString("DCMDeleteServersFormClient.deleteArchives.text")); // NOI18N
        deleteArchives.setToolTipText(bundle.getString("DCMDeleteServersFormClient.deleteArchives.toolTipText")); // NOI18N

        deleteButton.setFont(deleteButton.getFont().deriveFont(deleteButton.getFont().getSize()+1f));
        deleteButton.setText(bundle.getString("DCMDeleteServersFormClient.deleteButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("DCMDeleteServersFormClient.cancelButton.text")); // NOI18N
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        setVisible(false);
        try { dcManagerClient.deleteServersByForm(deleteArchives.isSelected()); } catch (CloneNotSupportedException ex) {   }
