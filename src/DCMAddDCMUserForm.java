...
public class DCMAddDCMUserForm extends javax.swing.JFrame
{
    DCMUser dcmUser;
    DCMDesktop inventoryGUI;

    public DCMAddDCMUserForm(DCMDesktop inventoryGUIParam) throws UnsupportedLookAndFeelException
    {
        inventoryGUI = inventoryGUIParam;
        dcmUser = new DCMUser();
        initComponents();
        try
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("DCMAddDCMUserForm"); // NOI18N
        addUserButton.setText(bundle.getString("DCMAddDCMUserForm.addUserButton.text")); // NOI18N
        ...
        userLabel.setText(bundle.getString("DCMAddDCMUserForm.userLabel.text")); // NOI18N

        passwordLabel.setFont(passwordLabel.getFont().deriveFont(passwordLabel.getFont().getSize()-1f));
        passwordLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        passwordLabel.setText(bundle.getString("DCMAddDCMUserForm.passwordLabel.text")); // NOI18N

        cancelButton.setFont(cancelButton.getFont().deriveFont(cancelButton.getFont().getSize()+1f));
        cancelButton.setText(bundle.getString("DCMAddDCMUserForm.cancelButton.text")); // NOI18N
        ...
        isAdministrator.setText(bundle.getString("DCMAddDCMUserForm.isAdministrator.text")); // NOI18N
        isAdministrator.setToolTipText(bundle.getString("DCMAddDCMUserForm.isAdministrator.toolTipText")); // NOI18N
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(userField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 395, Short.MAX_VALUE)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(addUserButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jLabel1.setText(bundle.getString("DCMAddDCMUserForm.jLabel1.text")); // NOI18N
    ...
    private void addUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUserButtonActionPerformed
        ...
        inventoryGUI.addDCMUserByForm(dcmUser);
    ...
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButtonActionPerformed
        ...
        dcmUser = new DCMUser();
        inventoryGUI.addDCMUserCanceled();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new DCMAddDCMUserForm().setVisible(true);
            }
        });
    }
